...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logo">Gurukul</a>
      ...
      <div class="icons">
         <a href="index.html"><div id="menu-btn" class="fas fa-home"></div></a>
...
<div class="side-bar">
   ...
   <nav class="navbar">
      <a href="dashboard.php"><i class="fas fa-bars"></i><span>Quick Access</span></a>
